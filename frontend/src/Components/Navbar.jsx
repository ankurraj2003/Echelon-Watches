...
const Navbar = () => {
  ...
  return (
    <div className="flex w-[100%] items-center justify-between py-5 font-medium ">
      <Link to="/">
        <img src="/logo11.png" className="w-40" alt="echelon" width="160" height="67"></img>
      </Link>
      ...
      <div className="flex items-center gap-6">
        ...
        <Link to="/cart" className="relative">
          <img src="/cart.png" className="w-5 min-w-8" />
      ...
      <div
        className={`absolute top-0 right-0 bottom-0 overflow-hidden  bg-[#111111] transition-all z-20 ${
          visible ? "w-full" : "w-0"
        }`}
      >
